  ...
  <div class="container">
        <div class="header_login">
            <form class="login_form" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                ...
                <?php endif; ?>
                <label for="username" class="label_login">اسم المستخدم</label>
                <input class="input-login" type="text" name="username" required>
                <label for="password" class="label_login">كلمة المرور</label>
                <input class="input-login" type="password" name="password" required>
                <button class="button_login" type="submit">تسجيل الدخول</button>
